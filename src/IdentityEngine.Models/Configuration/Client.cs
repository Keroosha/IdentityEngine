...
using IdentityEngine.Models.Configuration.Infrastructure;
...
namespace IdentityEngine.Models.Configuration
{
    ...
    public class Client
    {
        ...
        ///     The protocol type.
        /// </value>
        public string ProtocolType { get; set; } = InternalIdentityEngineConstants.ProtocolTypes.OpenIdConnect;
        ...
        public ICollection<string> AllowedGrantTypes
        {
            ...
            set
            {
                GrantTypesValidator.ValidateGrantTypes(value);
